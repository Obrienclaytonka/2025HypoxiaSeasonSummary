...
```{r, echo=FALSE, out.width="300%", fig_align = 'center', fig.retina=2, fig.cap = '<i>Windrose graph of wind speed and direction from Western Long Island Sound LISICOS Buoy during the summer of 2025 </i>'}
...
knitr::include_graphics("images/forecast_toll_hypoxia_depiction_2025.png")
